...
import RemoveRedEyeFilled1 from 'public/assets/food/images/RemoveRedEyeFilled.svg';
import RemoveRedEyeFilled2 from 'public/assets/food/images/RemoveRedEyeFilled.svg';
import RemoveRedEyeFilled3 from 'public/assets/food/images/RemoveRedEyeFilled.svg';
import ChevronRightFilled1 from 'public/assets/food/images/ChevronRightFilled.svg';
import ChevronRightFilled2 from 'public/assets/food/images/ChevronRightFilled.svg';
import ChevronLeftFilled1 from 'public/assets/food/images/ChevronLeftFilled.svg';
import StarFilled1 from 'public/assets/food/images/StarFilled.svg';
import StarHalfFilled1 from 'public/assets/food/images/StarHalfFilled.svg';
import StarFilled2 from 'public/assets/food/images/StarFilled.svg';
...
function Mui59Test(props: Mui59TestProps): JSX.Element {
  return (
    <Mui59Test1 className={props.className} >
      ...
      <Avatar1 >
        <Avatar2 variant="circular" src={`assets/food/images/Avatar_16.png`} alt={"Avatar"}   />
        <Avatar3 variant="circular" src={`assets/food/images/Avatar_15.png`} alt={"Avatar"}   />
        <Avatar4 variant="circular" src={`assets/food/images/Avatar_14.png`} alt={"Avatar"}   />
        <Avatar5 variant="square" src={`assets/food/images/Avatar_13.png`} alt={"Avatar"}   />
        <Avatar6 variant="square" src={`assets/food/images/Avatar_12.png`} alt={"Avatar"}   />
        <Avatar7 variant="square" src={`assets/food/images/Avatar_11.png`} alt={"Avatar"}   />
        <Avatar8 variant="rounded" src={`assets/food/images/Avatar_10.png`} alt={"Avatar"}   />
        <Avatar9 variant="rounded" src={`assets/food/images/Avatar_9.png`} alt={"Avatar"}   />
        <Avatar10 variant="rounded" src={`assets/food/images/Avatar_8.png`} alt={"Avatar"}   />
      </Avatar1>
      <Switch1 >
