...
import Avatar1Image from 'src/assets/food/images/Avatar_10.png';
import Avatar2Image from 'src/assets/food/images/Avatar_9.png';
import Avatar3Image from 'src/assets/food/images/Avatar_8.png';
import Frame3Image from 'src/assets/food/images/Frame_3.jpg';
...
function Frame2(props) {
  return (
    <Frame21 id={44}  className={props.className}  aria-label={"test1"} >
      ...
      <Avatar3 variant="circular" src={Avatar3Image} alt={"Avatar"}    inputProps={{"aria-label": "hello"}}/>
      ...
      <Tooltip id={33} arrow={true} placement={"top"}  title={'hello'}>
        ...
        <Tooltip id={55} arrow={true} placement={"top"}  title={undefined}>
          <Frame3 id={"55"}   src={Frame3Image} alt={"Frame 3"}/>
        </Tooltip>
        </Badge>
      </Frame3Wrapper>
      <Popover  
