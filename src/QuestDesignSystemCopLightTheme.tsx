...
import { ReactComponent as CheckCircleOutlined } from "src/assets/food/images/CheckCircleOutlined.svg"; 
import { ReactComponent as InfoOutlined } from "src/assets/food/images/InfoOutlined.svg"; 
import { ReactComponent as WarningAmberOutlined } from "src/assets/food/images/WarningAmberOutlined.svg"; 
import { ReactComponent as ErrorOutline } from "src/assets/food/images/ErrorOutline.svg"; 
import { ReactComponent as CheckBoxFilled } from "src/assets/food/images/CheckBoxFilled.svg"; 
import { ReactComponent as IndeterminateCheckBo } from "src/assets/food/images/IndeterminateCheckBoxFilled.svg"; 
import { ReactComponent as CheckBoxOutlineBlank } from "src/assets/food/images/CheckBoxOutlineBlankOutlined.svg"; 
  ...
  components: {
    ...
    MuiButton: {
      styleOverrides: {
        ...
        outlinedSecondary: {
          border: `1px solid rgba(2, 122, 209, 0.5)`, 
          boxSizing: `border-box`, 
          color: `rgba(2, 122, 209, 1)`,  
          "&:hover": {
            backgroundColor: globalTheme.palette["Secondary"]["Shades"]["4p"], 
      ...
      styleOverrides: {
        switchBase: {
          "&.MuiSwitch-colorPrimary": {
            color: "rgba(250, 250, 250, 1)","&:hover": {
